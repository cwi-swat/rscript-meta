...
public class Negative extends nl.cwi.sen1.relationstores.types.Integer {
  public Negative(nl.cwi.sen1.relationstores.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getRelationstoresFactory().makeInteger_Negative(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.relationstores.types.Integer)) { 
          throw new RuntimeException("Argument 0 of a Negative should have type Integer");
        }
        break;
      default: throw new RuntimeException("Negative does not have an argument at " + i );
    }
