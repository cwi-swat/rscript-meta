...
public class Area extends nl.cwi.sen1.relationstores.types.Area {
  public Area(nl.cwi.sen1.relationstores.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getRelationstoresFactory().makeArea_Area(fun, args, annos);
  }
  ...
  public nl.cwi.sen1.relationstores.types.Area setBeginLine(int _beginLine) {
    return (nl.cwi.sen1.relationstores.types.Area) super.setArgument(getFactory().makeInt(_beginLine), index_beginLine);
  }
  ...
  public nl.cwi.sen1.relationstores.types.Area setBeginColumn(int _beginColumn) {
    return (nl.cwi.sen1.relationstores.types.Area) super.setArgument(getFactory().makeInt(_beginColumn), index_beginColumn);
  }
  ...
  public nl.cwi.sen1.relationstores.types.Area setEndLine(int _endLine) {
    return (nl.cwi.sen1.relationstores.types.Area) super.setArgument(getFactory().makeInt(_endLine), index_endLine);
  }
  ...
  public nl.cwi.sen1.relationstores.types.Area setEndColumn(int _endColumn) {
    return (nl.cwi.sen1.relationstores.types.Area) super.setArgument(getFactory().makeInt(_endColumn), index_endColumn);
  }
  ...
  public nl.cwi.sen1.relationstores.types.Area setOffset(int _offset) {
    return (nl.cwi.sen1.relationstores.types.Area) super.setArgument(getFactory().makeInt(_offset), index_offset);
  }
  ...
  public nl.cwi.sen1.relationstores.types.Area setLength(int _length) {
    return (nl.cwi.sen1.relationstores.types.Area) super.setArgument(getFactory().makeInt(_length), index_length);
  }
