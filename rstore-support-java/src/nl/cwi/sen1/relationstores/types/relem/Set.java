...
public class Set extends nl.cwi.sen1.relationstores.types.RElem {
  public Set(nl.cwi.sen1.relationstores.Factory factory, aterm.ATermList annos, aterm.AFun fun, aterm.ATerm[] args) {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getRelationstoresFactory().makeRElem_Set(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.relationstores.types.RElemElements)) { 
          throw new RuntimeException("Argument 0 of a Set should have type RElem-elements");
        }
        break;
      default: throw new RuntimeException("Set does not have an argument at " + i );
    }
