...
public class Set extends nl.cwi.sen1.relationstores.types.RType {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getRelationstoresFactory().makeRType_Set(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.relationstores.types.RType)) { 
          throw new RuntimeException("Argument 0 of a Set should have type RType");
        }
        break;
