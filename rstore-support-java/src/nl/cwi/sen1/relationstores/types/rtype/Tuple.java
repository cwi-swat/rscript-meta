...
public class Tuple extends nl.cwi.sen1.relationstores.types.RType {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getRelationstoresFactory().makeRType_Tuple(fun, args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (!(arg instanceof nl.cwi.sen1.relationstores.types.RTypeColumnTypes)) { 
          throw new RuntimeException("Argument 0 of a Tuple should have type RType-column-types");
        }
        break;
