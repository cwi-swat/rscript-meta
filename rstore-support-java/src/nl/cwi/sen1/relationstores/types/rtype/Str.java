...
public class Str extends nl.cwi.sen1.relationstores.types.RType {
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] args, aterm.ATermList annos) {
    return getRelationstoresFactory().makeRType_Str(fun, args, annos);
  }
  ...
  public aterm.ATermAppl setArgument(aterm.ATerm arg, int i) {
      throw new RuntimeException("Str has no arguments");
  }
